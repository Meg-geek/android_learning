...
public interface HangGliderApi {
    @POST(APP + PRODUCTS + HANG_GLIDER + ADD)
    ...
    @GET(APP + PRODUCTS + HANG_GLIDER + GET_BY_DATE_GUILD)
    ...
    @GET(APP + PRODUCTS + HANG_GLIDER + GET_BY_DATE_SITE)
    ...
    @GET(APP + PRODUCTS + HANG_GLIDER + GET_BY_DATE_RANGE)
    ...
    @GET(APP + PRODUCTS + HANG_GLIDER + GET_NOW_BUILD_BY_COMPANY)
    Call<GeneralResponse<List<Product>>> getNowBuildingByCompany(
            @Query("id") int id
    );

    @GET(APP + PRODUCTS + HANG_GLIDER + GET_NOW_BUILD_BY_GUILD)
    Call<GeneralResponse<List<Product>>> getNowBuildingByGuild(
            @Query("id") int id
    );

    @GET(APP + PRODUCTS + HANG_GLIDER + GET_NOW_BUILD_BY_SITE)
